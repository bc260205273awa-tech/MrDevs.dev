    ...
    <section id="work" ref={containerRef} className="py-24 md:py-32 bg-bg-main font-sans overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 flex flex-col items-center">
        ...
        <div className="scroll-reveal group w-full bg-white/[0.02] backdrop-blur-3xl ring-1 ring-white/10 rounded-2xl overflow-hidden shadow-[0_0_80px_rgba(47,168,255,0.05)] transition-all duration-700 ease-out hover:shadow-[0_0_100px_rgba(47,168,255,0.1)] md:hover:[transform:perspective(1200px)_rotateX(2deg)_translateY(-8px)]">
          ...
          <div className="flex items-center justify-between px-6 py-4 bg-black/40 border-b border-white/5 backdrop-blur-md">
            ...
            {/* [CHANGED] Interactive URL Bar glow */}
            <a
              href="https://www.khanhub.com.pk/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 bg-black/40 border border-white/5 px-6 py-2 rounded-md text-xs text-text-body font-mono hover:text-accent-primary hover:border-accent-primary/50 hover:shadow-glow-cyan transition-all duration-300"
            >
              khanhub.com.pk
          ...
          <div className="p-8 md:p-12 lg:p-16 flex flex-col xl:flex-row gap-12 lg:gap-16">
            ...
            <div className="flex-1 flex flex-col gap-8">
              <div>
                ...
                <h3 className="text-3xl md:text-4xl font-bold text-text-heading tracking-tight leading-[1.1] max-w-lg">
              ...
              <div className="flex flex-col gap-6 max-w-lg mt-4">
                ...
                <div className="bg-white/5 border border-white/5 rounded-xl p-6 relative overflow-hidden group/solution">
            ...
            <div className="flex-1 flex flex-col gap-4 max-w-lg w-full">
              ...
              {/* Massive Top Widget */}
              <div className="relative bg-bg-deep border border-white/5 rounded-2xl p-8 flex flex-col items-start justify-center h-48 overflow-hidden group/widget">
                <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-accent-primary/20 blur-[50px] rounded-full"></div>
                <span className="relative z-10 text-accent-primary text-5xl md:text-6xl font-bold tracking-tighter mb-1">
                  50K+
                </span>
                <span className="relative z-10 text-sm text-text-body font-medium tracking-wide">
              ...
              <div className="flex gap-4 h-40">
                <div className="flex-1 bg-bg-deep border border-white/5 rounded-2xl p-6 flex flex-col justify-end relative overflow-hidden">
                  <div className="absolute -top-10 -left-10 w-32 h-32 bg-accent-cyan/10 blur-[40px] rounded-full"></div>
                  <span className="relative z-10 text-text-heading text-3xl font-bold tracking-tight mb-1">
                    16+
                  </span>
                  <span className="relative z-10 text-xs text-text-body font-medium uppercase tracking-wider">
                    Departments
                  </span>
                </div>
